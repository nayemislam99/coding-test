                            ...
                            <div class="col-md-9">
                                <div class="card">
                                    ...
                                    <div class="card-body shadow-sm">
                                        ...
                                        <form action="{{ route('dashboard.withdrawl.amount') }}" method="post">
                                            @csrf

                                            <div class="mb-2">
                                                <label for="withdrawl_amount" class="form-label">Withdrawl Amount</label>
                                                <input type="text" name="withdrawl_amount" class="form-control"
                                                    id="withdrawl_amount" />
                                            </div>

                                            <button type="submit" class="btn btn-success">Widhdrawl</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
